...
//               {quotes.map((quote) => {
//                 const isOwn = isOwnQuote(quote);
//                 // ✅ ใช้ utility function เพื่อดู status
//                 const voteStatus = getVoteStatus(quote, quotes);
//                 // ✅ เช็คว่า user โหวตคำคมนี้หรือไม่
//                 const isVoted = hasUserVoted(quote);
...
//                         <blockquote className="text-gray-800 dark:text-gray-200 font-medium leading-relaxed text-lg">
//                           "{quote.content}"
//                         </blockquote>
...
//                             }
//                           >
//                             {/* ✅ แก้ไขหัวใจให้แสดง fill state ถูกต้อง */}
//                             <Heart
//                               className={`w-5 h-5 transition-all duration-200 ${
//                                 isVoted
//                                   ? "fill-red-500 text-red-500 scale-110"
...
//                                   <div
//                                     key={voter.user_id}
//                                     className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-xs text-white font-bold border-2 border-white dark:border-gray-800"
//                                     title={voter.user_name}
//                                   >
